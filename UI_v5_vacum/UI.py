...
VACUM_OFFSET=80		#amount of negative offset to vacum
					#if Vacum is enable on channel, set Y
VACUM_ENABLE=[False, False, False, False, False, False, False, False, False, False, False, False, True] 

VAL_MAX=890			#abs min max of the input value, 800 should be abs max
VAL_MIN=-80
VACUM_MIN=-VACUM_OFFSET
REG_MIN=0
