...
class Robot:
	...
	##################Channel sequence of the robot is set here, with the delay that may between each step use the "time.sleep(t)" function 
...
#####################called function for the UI button, just passes function to a more redable format
#####################(Not nessessary bc robot.function_name(parameter) could be called directly from partial)
...
def main():
	...
	###########################Create UI elements of different function
