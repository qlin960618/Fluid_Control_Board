...
#################Initialization of pressure variables for each channel
...
#Channel Index confirguation in the format of "Channel_Name"="Channel_ID"
CH1 = 0	#channel 1
CH2 = 1	#channel 2
CH3 = 2	#channel 3
CH4 = 3	#channel 4
...
class Robot:
	def __init__(self, SerialPort):
		...
		self.board=FCB()
		#Print all Serial port in the command window
	...
	#Initialize all channels by adding individual channel to the list
