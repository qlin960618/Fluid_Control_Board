...
class App:
	...
	def __init__(self, masterWindow):	
		...
		self.mismatchLabel2=tk.Label(self.infoFrame,text="In progress")
		self.mismatchLabel2.grid(row=2, column=0)


		#Serial Frame
		self.serialFrame=tk.Frame(self.masterWindow)
		...
		self.savePathVar.set("./Temp.fcbset")
	...
	def load_Parameter(self):
		...
		self.zero_All()
		for i in range(N_CHANNEL):
			self.maxEntryVar[i].set(storedVec[i*2+1])
			self.set_Max(i, 0)
